...
1. NEW: Standalone HTML Presentations (Active)
   Location: /static/presentations/course-book/2-infrastructure/compute/
...
FROM (new):
  [Watch the presentation](/presentations/course-book/2-infrastructure/compute/X-topic.html)
