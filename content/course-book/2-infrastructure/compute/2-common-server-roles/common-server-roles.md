...
[Watch the presentation](/presentations/course-book/2-infrastructure/compute/2-common-server-roles.html)

[Se presentationen på svenska](/presentations/course-book/2-infrastructure/compute/2-common-server-roles-swe.html)
