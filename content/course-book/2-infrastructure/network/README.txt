...
1. NEW: Standalone HTML Presentations (Active)
   Location: /static/presentations/course-book/2-infrastructure/network/
...
FROM (new):
  [Watch the presentation](/presentations/course-book/2-infrastructure/network/X-topic.html)
